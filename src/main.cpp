...
int main() {
    ...
    CRTTriangle triangle(CRTVector(-2.f,-2.f,-3.f),CRTVector(1.75f,-1.75f,-3.f),CRTVector(0.f,1.75f,-3.f));
    ...
    CRTVector cameraPosition(-2.f,-1.f,1.f);
    ...
    CRTTriangle tri1(CRTVector(-2.f,0.0f,-3.f),CRTVector(-1.f,0.f,-3.f),CRTVector(-2.f,1.f,-3.f));
